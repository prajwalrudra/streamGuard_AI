    ...
    <header className="glass-strong border-b border-[hsl(220,12%,22%)] px-6 py-3 flex items-center justify-between sticky top-0 z-50">
      ...
      <div className="flex items-center gap-6">
        ...
        <nav className="hidden md:flex items-center gap-2">
          <Link
            href="/"
            className="px-3 py-1.5 rounded-lg text-xs font-medium text-[hsl(220,10%,65%)] hover:text-white hover:bg-[hsl(220,16%,14%)] transition-colors flex items-center gap-1.5"
          >
            <span>🏠</span> Home UI
          </Link>
          <Link
